	...
	<form action="modificacion_dispositivo.php?id_disp=<?php echo $id_disp;?>&id_estado_actual=<?php echo $id_estado;?>&id_sala_actual=<?php echo $id_sala;?>&codigo_ped=<?php echo $codigo_ped;?>" class="form-container" method="post">
		<div class="card">
			...
			<div class="text-center">
				<button data-target="modal1" class="btn boton waves-effect waves-light modal-trigger">Información</button>
			</div>
			  <div id="modal1" class="modal">
			    <div class="modal-content">
			    	<div class="row caja_titulo">
			    		<h4 calss="titulo">Información</h4>		
			    	</div>
			      <p>
				  Puesto que este dispositivo se dió de alta automáticamente a raíz de un pedido, para evitar la incongruencia de datos, el sistema no permite realizar las siguientes modificaciones sobre el dispositivo actual:
				  </p>
				  <p>
				  -Fecha de alta.
				  </p>
